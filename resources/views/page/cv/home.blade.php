        ...
        <div>
                ...
                <div class="wrapper">
                    <div class="page-header page-header-small" filter-color="green">
                        <div class="page-header-image" data-parallax="true"
                            style="background-image:{{ asset('assets/cv/images/cc-bg-1.jpg') }} "></div>
                        <div class="container">
                            <div class="content-center">
                                <div class="cc-profile-image"><a href="#"><img
                                            src="{{ asset('assets/cv/images/hieukun_n.jpg') }}" alt="Image" /></a></div>
                                <div class="h2 title">Tran Nhan Hieu</div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/project-1.jpg') }}" alt="Image" />
                                                    <figcaption>
                                        ...
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/project-2.jpg') }}" alt="Image" />
                                                    <figcaption>
                                    ...
                                    <div class="col-md-6">
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/project-3.jpg') }}" alt="Image" />
                                                    <figcaption>
                                        ...
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/project-4.jpg') }}" alt="Image" />
                                                    <figcaption>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/graphic-design-1.jpg') }}"
                                                        alt="Image" />
                                                    <figcaption>
                                        ...
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/graphic-design-2.jpg') }}"
                                                        alt="Image" />
                                                    <figcaption>
                                    ...
                                    <div class="col-md-6">
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/graphic-design-3.jpg') }}"
                                                        alt="Image" />
                                                    <figcaption>
                                        ...
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/graphic-design-4.jpg') }}"
                                                        alt="Image" />
                                                    <figcaption>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/photography-1.jpg') }}"
                                                        alt="Image" />
                                                    <figcaption>
                                        ...
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/photography-2.jpg') }}"
                                                        alt="Image" />
                                                    <figcaption>
                                    ...
                                    <div class="col-md-6">
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/photography-3.jpg') }}"
                                                        alt="Image" />
                                                    <figcaption>
                                        ...
                                        <div class="cc-porfolio-image img-raised" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                                <figure class="cc-effect"><img
                                                        src="{{ asset('assets/cv/images/photography-4.jpg') }}"
                                                        alt="Image" />
                                                    <figcaption>
                        ...
                        <div class="carousel slide" id="cc-Indicators" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="row">-1.jpg')
                                        <div class="col-lg-2 col-md-3 cc-reference-header"><img
                                                src="{{ asset('assets/cv/images/reference-image-1.jpg') }}" alt="Image" />
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-lg-2 col-md-3 cc-reference-header"><img
                                                src="{{ asset('assets/cv/images/reference-image-2.jpg') }}" alt="Image" />
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-lg-2 col-md-3 cc-reference-header"><img
                                                src="{{ asset('assets/cv/images/reference-image-3.jpg') }}" alt="Image" />
            ...
            <div class="section" id="contact">
                <div class="cc-contact-information"
                    style="background-image: {{ asset('assets/cv/images/staticmap.png') }}">
                    <div class="container">
